...
* Modelado de datos y limpieza en MySQL
* Construcción de KPIs estratégicos en Power BI
* Identificación de drivers de churn por pricing, tenure y contract type
* Detección de segmentos con mayor tasa de abandono
* Storytelling ejecutivo con insights orientados a negocio
* Recomendaciones de retención basadas en segmentación de clientes <br>
* 👉 Ver proyecto (https://github.com/DiegoFCd/Customer-Churn-Analysis-Retention-Dashboard) <br>
...
* Identificación KPIs relevantes para el cliente
* Aplicacion de método MBA (Marker Basket Analysis)
* 👉 Ver proyecto (https://github.com/DiegoFCd/Super-Sano-y-Fresco) <br>
...
* Evolución de producciones por año
* Insights sobre distribución de géneros <br>
* 👉 Ver proyecto (https://github.com/DiegoFCd/Netflix_Analysis) <br>
